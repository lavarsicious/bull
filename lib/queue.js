...
Queue.prototype._initProcess = function() {
  if (!this._initializingProcess) {
    ...
    //
    this.delayedTimestamp = 2147483647;
...
Queue.prototype.updateDelayTimer = function() {
  return scripts
    ...
    .then(nextTimestamp => {
      this.delayedTimestamp = nextTimestamp ? nextTimestamp / 4096 : 2147483647;
...
Queue.prototype.whenCurrentJobsFinished = function() {
  ...
  return Promise.all([this.drained || this.processing[0]]).then(() => {
